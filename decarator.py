...
def logger(old_function):
    ...
    def new_function(*args, **kwargs):
        ...
        print(f'Функция {old_function.__name__} работал {end - start} секунд')
        with open('main.log', 'a', encoding='utf-8') as log_file:
            log_file.write(f'дата и время вызова функции {old_function.__name__} - {start}, {args=}, {kwargs=}, {result=} \n')
        return result
    return new_function
